...
kotlin {
    ...
    val xcf = XCFramework("Winsplit")

    macosArm64 {
        binaries.framework { baseName = "Winsplit"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Winsplit"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Winsplit"
        flattenPackage = "io.github.kotlinmania.winsplit"
    }

    android {
        namespace = "io.github.kotlinmania.winsplit"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "winsplit-kotlin", version.toString())

    pom {
        name.set("winsplit-kotlin")
        description.set("Kotlin Multiplatform port of chipsenkbeil/winsplit-rs - Library to split string into command line arguments mirroring CommandLineToArgV with VC++ 2008 parsing rules")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/winsplit-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/winsplit-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/winsplit-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/winsplit-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleWinsplitXCFramework",
    "assembleWinsplitDebugXCFramework",
    "assembleWinsplitReleaseXCFramework",
    "assembleDebugIosFatFrameworkForWinsplitXCFramework",
    "assembleReleaseIosFatFrameworkForWinsplitXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForWinsplitXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForWinsplitXCFramework",
    "assembleDebugMacosFatFrameworkForWinsplitXCFramework",
    "assembleReleaseMacosFatFrameworkForWinsplitXCFramework",
    "assembleDebugTvosFatFrameworkForWinsplitXCFramework",
    "assembleReleaseTvosFatFrameworkForWinsplitXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForWinsplitXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForWinsplitXCFramework",
    "assembleDebugWatchosFatFrameworkForWinsplitXCFramework",
    "assembleReleaseWatchosFatFrameworkForWinsplitXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForWinsplitXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForWinsplitXCFramework",

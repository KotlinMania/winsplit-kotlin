...
This file is the quick-reference operating contract for winsplit-kotlin. The longer
...
winsplit-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`winsplit`](https://crates.io/crates/winsplit). Upstream Rust is the behavioral oracle while the
